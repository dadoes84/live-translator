...
3. On first launch, open **AI 设置** (AI Settings), enter your DeepSeek API Key, and click **检测** (Test) to verify
...
| 3 | Click **AI 设置**, fill in your DeepSeek API Key, choose a model, customize the prompt |
...
3. 首次启动后，打开「AI 设置」填入 DeepSeek API Key，点击「检测」验证连通性
...
| 3 | 点击「AI 设置」，填入 DeepSeek API Key，选择模型，自定义提示词 |
| 4 | 点击「开始」，启动实时翻译 |
| 5 | 点击 📌 将窗口置顶，方便边看边译 |
